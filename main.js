...
recognition.onresult = function(event) {
 ...
 content = event.results[0][0].transcript;
    ...
    document.getElementById("status").innerHTML = "The speech system has been recognized: " + content; 
    ...
    if (Number.isInteger(to_number)){
      ...
      document.getElementById("status").innerHTML = "The speech system has not recognized a number."; 
    }
}
